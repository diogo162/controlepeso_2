...
import br.upe.aula.controlepeso.servico.PesoServico;
...
public class ControlePesoAPI {
    ...
    public Usuario buscaUsuario(@PathVariable String email){
    ...
    @PutMapping("/usuario/peso/{email}")
    public peso alterarPeso(@PathVariable String email){
        return this.pesoServico.montarMonitoramento(email);
    }
}
